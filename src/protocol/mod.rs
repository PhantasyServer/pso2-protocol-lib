...
pub enum Packet {
    ...
    // Server packets [0x03]
    #[pso2packet(category(PacketCategory::Server))]
    ...
    #[pso2packet(category(PacketCategory::Object))]
    ...
    #[pso2packet(category(PacketCategory::PlayerStatus))]
    ...
    // Chat packets [0x07]
    #[pso2packet(category(PacketCategory::Chat))]
    /// (0x07, 0x00) Chat Message.
    #[pso2packet(id(0x07, 0x00))]
    ChatMessage(ChatMessage),

    // Spawn packets [0x08]
    #[pso2packet(category(PacketCategory::Spawning))]
    ...
    #[pso2packet(category(PacketCategory::QuestList))]
    ...
    // Party packets [0x0E]
    #[pso2packet(category(PacketCategory::Party))]
    ...
    // Item packets [0x0F]
    #[pso2packet(category(PacketCategory::Item))]
    ...
    #[pso2packet(category(PacketCategory::Unk10))]
    /// (0x10, 0x00) Run Lua.
    ...
    // Login packets [0x11]
    #[pso2packet(category(PacketCategory::Login))]
    ...
    #[pso2packet(id(0x11, 0x02))]
    CharacterListRequest,
    /// (0x11, 0x03) Character List.
    #[pso2packet(id(0x11, 0x03))]
    #[pso2packet(Classic)]
    ...
    #[pso2packet(category(PacketCategory::Emergency))]
    ...
    #[pso2packet(category(PacketCategory::Friends))]
    ...
    #[pso2packet(category(PacketCategory::Unk19))]
    ...
    ///
    /// (C -> S)
    #[pso2packet(id(0x19, 0x04))]
    Unk1904,
    /// (0x19, 0x06) Unknown.
    ///
    /// (C -> S)
    #[pso2packet(id(0x19, 0x06))]
    Unk1906,
    ...
    // Mail packets [0x1A]
    #[pso2packet(category(PacketCategory::Mail))]
    ...
    #[pso2packet(id(0x1A, 0x0D))]
    NewMailMarker,

    // PSE Burst packets [0x1B]
    #[pso2packet(category(PacketCategory::PseBurst))]
    ...
    #[pso2packet(category(PacketCategory::Characters))]
    ...
    #[pso2packet(id(0x1C, 0x10))]
    GetAllianceStatus,

    // Unknown 0x1E packets [0x1E]
    #[pso2packet(category(PacketCategory::Unk1E))]
    /// (0x1E, 0x0C) Unknown.
    #[pso2packet(id(0x1E, 0x0C))]
    Unk1E0C(Unk1E0CPacket),

    // Daily order packets [0x1F]
    #[pso2packet(category(PacketCategory::DailyOrders))]
    ...
    #[pso2packet(category(PacketCategory::Palette))]
    ...
    // Flag packets [0x23]
    #[pso2packet(category(PacketCategory::Flag))]
    /// (0x23, 0x02) Set Flag.
    ...
    #[pso2packet(category(PacketCategory::FriendAvatar))]
    ...
    #[pso2packet(category(PacketCategory::Unk2A))]
    /// (0x2A, 0x08) Unknown.
    #[pso2packet(id(0x2A, 0x08))]
    Unk2A08(Unk2A08Packet),

    // Settings packets [0x2B]
    #[pso2packet(category(PacketCategory::Settings))]
    ...
    #[pso2packet(category(PacketCategory::PlayerShop))]
    ...
    #[pso2packet(category(PacketCategory::SymbolArt))]
    ...
    #[pso2packet(category(PacketCategory::Unk34))]
    /// (0x34, 0x35) Unknown.
    ...
    #[pso2packet(category(PacketCategory::CollectionFolder))]
    ...
    #[pso2packet(category(PacketCategory::ARKSMissions))]
    ...
    #[pso2packet(category(PacketCategory::MissionPass))]
